...
@section('content')
    <div class="container">
        ...
        <div class="mt-5 row justify-content-center">
            ...
            action="{{route('establecimiento.store')}}" class="col-md-9 col-xs-12 card card-body" method="POST">
                @csrf
                <fieldset class="border p-4">
                    <legend class="text-primary float-none w-auto">Nombre, Categoria e Imagen Principal de Negocio</legend>
                ...
                <fieldset class="border p-4 mt-5">
                    <legend class="text-primary float-none w-auto">Ubicacion:</legend>
                    ...
                    <p class="informacion">Confirma que los siguiente campos son correctos</p>
