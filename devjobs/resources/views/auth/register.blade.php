...
<div class="container mx-auto max-w-screen-md">
    <div class="flex flex-wrap justify-center">
                        ...
                        <form class="py-10 px-5" method="POST" action="{{ route('register') }}" novalidate>
                            ...
                            <div class="flex flex-wrap mb-6">
                                <label for="name" class="block text-gray-700 text-sm mb-2">{{ __('Name') }}</label>
                                    ...
                                    @error('name')
                                        <span class="bg-red-100 border-l-4 border-red-500 text-red-700 p-2 w-full mt-4 text-sm" role="alert">
        ...
        <div class="md:w-1/2 md:order-2 text-center flex flex-col justify-center px-10 mt-10">
            <h1 class="text-teal-500 text-3xl">¿Eres Reclutador?</h1>
            <p class="text-xl mt-5 leading-7">Crea una cuenta totalmente gratis y comienza a publica hasta 10 vacantes</p>
        </div>
    </div>
</div>
@endsection
