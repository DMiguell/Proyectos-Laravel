    ...
    <div class="mt-10 mb-20 md:flex items-start">
        <div class="md:w-3/5">
            ...
            @php
                ...
                <p class="inline-block border border-gray-400 py-2 rounded px-8 text-gray-700 font-bold my-2">
        ...
        {{-- 
            Con esto seria otra experiencia ya que solo desactivaria el formulario de enviar tu nombre y cv pero = podriamos ver 
            los datos que pedia la vacante
        @if ($vacante->activa ===1)
            @include('ui.contacto')
        @endif --}}
        @include('ui.contacto')
